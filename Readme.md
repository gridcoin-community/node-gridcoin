...
a certificate signed by an actual CA, to ensure you are connecting to your own gridcoinresearchd.
...
then `sslStrict` should be set to `false` because by default node won't work with 
